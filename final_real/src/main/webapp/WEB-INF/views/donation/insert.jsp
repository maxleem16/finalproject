...
<body>
	...
	<form name="frm1" action="insert2" method="post">
		...
		<table border=1>
			<tr>
				<td>후원자</td>
				<td><input type="text" name="sponsor" value="user01"></td>
			</tr>
			<tr>
				<td>후원금액</td>
			...
			<tr>
				<td>한마디</td>
				<td><textarea name="sponsorContent" cols=50 rows=3></textarea></td>
			</tr>
		</table>
		<img src="/resources/img/payment_icon_yellow_medium.png" class="icon" style="cursor:pointer;">
	</form>
</body>
<script>

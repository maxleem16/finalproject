...
<body>
	<h1>[회원가입]</h1>
		<table border=1 width=450>
			<tr>
				<td width=150>아이디</td>
				<td><input type="text" size=16 id="id"> <button id="btnCheck">중복확인</button></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" size=4 id="birthday1">년
					<input type="text" size=2 id="birthday2">월
					<input type="text" size=2 id="birthday3">일
				</td>
			</tr>
			<tr>
				<td width=150>주소</td>
			...
			<tr>
				...
				<td>
					<input type="text" size=16 id="tel1">
					<input type="text" size=16 id="tel2">
					<input type="text" size=16 id="tel3">
				</td>
			</tr>
			<tr>
				<td width=150>이메일</td>
				<td>
					<input type="text" size=16 id="email">
				</td>		
			</tr>
		</table>

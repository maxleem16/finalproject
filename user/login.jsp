...
<body>
	<form name="frm" action="login" method="post" class="frmLogin">
		...
		<div id="tblLogin">
			<div id="loginlogo" onClick="location.href='../index'" style="cursor:pointer;"><img src="/resources/img/logo.png" alt="인덱스로 이동"></div>
			<div id="login">
			...
			<div id="joinus">
				Don't have an account? <a href="insert"> &nbsp;join us!</a>
			</div>
		</div>
	</form>
</body>
<script type="text/javascript">
	var naver_id_login = new naver_id_login("c3B_nFy0kk6mprA8QcQ8", "http://localhost:8088/user/loginNaver");

...
public class infoReportVO {
   ...
   public String toString() {
      return "infoReportVO [foundTime=" + foundTime + ", foundLocation=" + foundLocation + ", dogImage=" + dogImage + ", dogImages=" + dogImages
            + ", protection=" + protection + ", reward=" + reward + ", tel=" + tel + ", writer=" + writer

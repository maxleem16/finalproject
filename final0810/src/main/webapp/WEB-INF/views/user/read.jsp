        ...
        <table border=1 width=400 id="userUD">
            ...
            <tr>
                <td class="UDtitle">주소</td>
                  <td class="UD"><input type="text" name="address" size=16 value="${vo.address}"></td>
            </tr>
            <tr>
                <td class="UDtitle">전화번호</td>
                  <td class="UD"><input type="text" name="tel" size=16 value="${vo.tel}"></td>
            </tr>
            <tr>
                <td class="UDtitle">이메일</td>
                <td class="UD"><input type="text" name="email" size=16 value="${vo.email}"></td>
            </tr>
            </table>      
        <div class="btnUD"> 

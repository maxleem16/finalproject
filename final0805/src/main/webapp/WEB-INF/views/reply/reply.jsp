...
<head>
   ...
   <style>
      .divContent{width:250px;padding:10px;margin:10px;background:blue;color:white;border:1px solid black;font-size:12px;}
...
<body>
   ...
   <div id="divInput">
      댓글수:<span id="count"></span><br>
      <input type="text" id="txtReply" size=28>
...
<script>
   ...
   $("#btnInsert").on("click", function(){
      ...
      alert(postingNo+commentContent+writer);
      if(commentContent==""){
         alert("내용을 입력하세요!");
         return;
      }
